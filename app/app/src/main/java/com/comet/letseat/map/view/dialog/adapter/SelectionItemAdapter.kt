 ...
 * @param onChecked 각 체크박스 클릭시 처리할 콜백, param은 position
 */
class SelectionItemAdapter(private val layoutInflater : LayoutInflater, private val context : Context, private val onChecked : (Int) -> Unit) : RecyclerView.Adapter<SelectionItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelectionItemViewHolder {
        ...
        return SelectionItemViewHolder(view, context, onChecked)
    }
 ...
 */
class SelectionItemViewHolder(private val view : ChooseItemBinding, private val context: Context, private val onChecked: (Int) -> Unit) : RecyclerView.ViewHolder(view.root), CompoundButton.OnCheckedChangeListener {
